...
macOS notarization is not configured yet. Git integration is not built into the UI yet; use a Git-tracked custom brain folder if you want version history.
