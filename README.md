...
macOS notarization is not configured yet. Git integration is intentionally lightweight: it shows status, can initialize a local repo, and copies commit commands, but does not commit, push, pull, or manage remotes.
